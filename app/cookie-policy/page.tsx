  ...
  return (
    <main style={{ fontFamily: 'Georgia, serif', backgroundColor: '#120025', color: '#f0eaf8', margin: 0, padding: 0 }}>
      ...
      <div style={{
        ...
        <p style={{ color: '#c9a8f0', fontFamily: 'sans-serif', fontSize: '13px' }}>Last updated April 25, 2026</p>
      </div>
      ...
      <div style={{
        ...
        <style>{`
          .cp h2 { color: #f0eaf8; font-size: 20px; font-weight: 400; margin-top: 48px; margin-bottom: 12px; border-bottom: 1px solid #3d1070; padding-bottom: 8px; }
          .cp p { margin-bottom: 16px; }
          .cp ul { margin: 12px 0 16px 24px; }
          .cp li { margin-bottom: 8px; }
          .cp a { color: #c9a8f0; }
          .cp strong { color: #f0eaf8; }
        `}</style>

        <div className="cp">

          <p>This Cookie Policy explains how <strong>Klarvoya INC</strong> ("Company," "we," "us," and "our") uses cookies and similar technologies to recognize you when you visit our website at <a href="http://www.klarvoya.com" target="_blank" rel="noopener noreferrer">http://www.klarvoya.com</a> ("Website"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
          ...
          <p>Cookies set by the website owner (in this case, Klarvoya INC) are called "first-party cookies." Cookies set by parties other than the website owner are called "third-party cookies." Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g., advertising, interactive content, and analytics). The parties that set these third-party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites.</p>
          ...
          <ul>
            <li><a href="https://support.google.com/chrome/answer/95647#zippy=%2Callow-or-block-cookies" target="_blank" rel="noopener noreferrer">Chrome</a></li>
          ...
          <p>If you have any questions about our use of cookies or other technologies, please email us at <a href="mailto:info@klarvoya.com">info@klarvoya.com</a> or by post to:</p>
          <p>
